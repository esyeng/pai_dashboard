...
//         }
//         return await supabaseClient.from("users").select().eq('user_id', responseObj.user_id)
//             .then((data) => {
...
//         // const token = await getLatestToken();
//         if (supabaseClient === null) {
//             throw new Error("Threads: Supabase client is null");
//         }

//         const { data, error } = await supabaseClient.from("threads").select("*");
//         if (error) {
...
//     try {
//         if (supabaseClient === null) {
//             throw new Error("Assistants: Supabase client is null");
//         }
...
//     try {
//         if (supabaseClient === null) {
//             throw new Error("Models: Supabase client is null");
//         }
...
//     try {
//         if (supabaseClient === null) {
//             throw new Error("Save Thread: Supabase client is null");
//         }
...
//     try {
//         if (supabaseClient === null) {
//             throw new Error("Update Thread Name: Supabase client is null");
//         }
...
//     try {
//         if (supabaseClient === null) {
//             throw new Error("Update Thread Messages: Supabase client is null");
//         }
